    ...
    if args.create_watched_source:
        ...
        try:
            ...
            watched_db_manager.add_hashes_to_watched_db(
                abs_db_path_to_use, all_hashes_set
            )
        ...
        # --- Standard Mode (Find Duplicates/Watched) ---
        ...
        print("-" * 30)
        print("Mode: Find Similar/Watched Videos")
        print(f"Scanning target directory: '{abs_target_directory}'")
        ...
        try:
            ...
            moved_watched_files = (
                set()
            )  # Keep track of files successfully moved as watched
            ...
            if args.watched_db:
                ...
                watched_hashes_set = watched_db_manager.load_watched_hashes(
                    args.watched_db
                )
